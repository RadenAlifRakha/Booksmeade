            ...
            <div class="bg-white shadow px-20 mb-6">
                <div class="flex justify-between items-center">
                    <a href="{{ route('beranda') }}">
                        <img src="{{ asset('img/logo-buku2.png') }}" alt="" width="100" height="100">
                    </a>
                    <div class="flex space-x-10 items-center">
                        ...
                        {{-- <a href="{{ route('buku.random') }}" class="bg-transparent text-green-700 border-2 border-green-700 hover:bg-green-800 hover:text-white hover:border-transparent font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 flex items-center gap-2">
                    ...
                    @else
                        <div class="flex items-center gap-2 mt-5">
                            <a href="{{ route('login') }}" class="w-24 text-white bg-blue-900 hover:bg-blue-700 hover:text-white focus:ring-2 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-5">Login</a>
                            <a href="{{ route('register') }}" class="w-24 text-white bg-indigo-900 hover:bg-indigo-700 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-5">Register</a>
                        </div>
                        @endauth
                    @endif
                </div>
            ...
            <div class="w-full max-w-screen-xl mx-auto p-2">
                <div class="flex items-center justify-between">
                    <a href="{{ route('beranda') }}" class="flex items-center mb-4 space-x-3">
                        <img src="{{ asset('img/logo-buku3.png') }}" alt="" width="115" height="115">
                    </a>
                </div>
